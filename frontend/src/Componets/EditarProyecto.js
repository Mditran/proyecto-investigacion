                ...
                <div className="card px-1 py-4">
                    <div className="card-body">
                        ...
                        <form onSubmit={this.submitUsuario} id="create-course-form">
                            ...
                            <div class="input-group  mb-3">
                                <input type="text" class="form-control" placeholder="Nombre" ref="leadername" value={this.state.leadername} onChange={(e) => this.setState({leadername: e.target.value})}/>
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                        </div>
                        <div class="input-group  mb-3">
                                <input type="text" class="form-control" placeholder='Identificacion' ref="leaderid" value={this.state.leaderid} onChange={(e) => this.setState({leaderid: e.target.value})}/>
                            ...
                            <div class="input-group  mb-3">
                                <input type="date" class="form-control" ref="startdate" value={this.state.startdate} onChange={(e) => this.setState({startdate: e.target.value})} />
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-play" aria-hidden="true"></i></span>
                            </div>
                            <div class="input-group  mb-3">
                                <input type="date" class="form-control" ref="enddate" value={this.state.enddate} onChange={(e) => this.setState({enddate: e.target.value})}/>
                            ...
                            <div class="input-group  mb-3">
                                <select className="form-select form-select-lg mb-3" onChange={(e) => this.setState({definite: e.target.value})} id="inputGroupSelect02">
                            ...
                            <div class="input-group  mb-3">
                                <select className="form-select form-select-lg mb-3" onChange={(e) => this.setState({fase: e.target.value})} id="inputGroupSelect02">
